...
func set_tint():
	...
	animated_sprite_2d.material.set_shader_parameter("color", placeholder_color)

func set_error_tint():
	animated_sprite_2d.material.set_shader_parameter("color", placeholder_error_color)
